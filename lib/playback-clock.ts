...
export function readPlaybackSample(netflix: unknown, path: string, ad: boolean): PlaybackSample {
...
export function hasVisibleAd(doc: Document): boolean {
  const selector = '[data-uia="ad-break"], [data-uia="ad-countdown"], [data-uia="ads-info"], .watch-video--ads-info';
  return Array.from(doc.querySelectorAll<HTMLElement>(selector)).some(element => {
